            ...
            >
                ...
                <div
                    ...
                    className={cn(
                        ...
                        "backdrop-blur-[2px] border-2 border-gray-300/70",
...
function HeroGeometric({
    ...
    return (
        ...
        <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-white pt-10">

            <div className="absolute inset-0 bg-gradient-to-br from-blue-100/[0.6] via-transparent to-cyan-100/[0.6] blur-3xl" />
            ...
            <div className="relative z-0 container mx-auto px-4 md:px-6">
                ...
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    >
                        ...
                        <span className="text-sm text-blue-700/80 tracking-wide">
                        ...
                        <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold mb-6 md:mb-8 tracking-tight">
                            ...
                            <span
                                ...
                                className={cn(
                                    ...
                                    "bg-clip-text text-transparent bg-gradient-to-r from-blue-600 via-cyan-600 to-teal-600 "
                    ...
                    >
                        ...
                        <p className="text-base sm:text-lg md:text-xl text-gray-600 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
                            ...
                            {description || "Modern diş hekimliği hizmetleri ile sağlıklı gülüşlerinize kavuşun. Uzman ekibimiz ve son teknoloji ekipmanlarımızla yanınızdayız."}
